...
Additionally, we reviewed the official documentation for R, ggplot, plot_ly, and quarto for information on specific functions, usage information, and in some cases tutorials
