...
Our analysis found that individuals with prior VR experience reported heightened symptoms when exposed to VR, compared to those without prior experience. Age and gender had little to no effect. Further research should examine the nature, amount, and frequency of prior VR use to improve result accuracy.
...
Participants with and without VR experience reported varied severity of symptoms. Interestingly, the VR-experienced group saw a greater median `ssq_full`, at 7.0 compared to -0.5 for those without experience, indicating they reported more severe symptoms after exposure to VR. VR-experienced participants also showed a greater IQR than those without experience, at 16.25 compared to 8.5, pointing to experienced users reporting less consistent symptom severity. The difference in average rating from the Simulator Sickness Questionnaire (SSQ) is consistently lower for less experienced users. These observations contrast previous research suggesting VR users with experience undergo less motion sickness (Chattha et al., 2020). This could be due to the smaller sample space, wherein it is given that each person's experience will vary too significantly for a strong correlation to be found across results in different papers. Additionally, users who have experienced motion sickness in VR before may anticipate feeling sick again, which could lead to heightened symptoms, similar to a placebo.
...
There appears to be substantial overlap between SSQ scores of different age groups across both the “With Experience” and “No Experience” conditions. In both sets of boxplots, medians remain relatively close, with no consistent trend among increasing age groups.

Notably, while SSQ spread varies, there seems to be no consistent pattern across age groups. For example, in the “With experience” condition, the 16–21 group has a wide IQR with higher scores, while the 38–45 group has a smaller IQR but also exhibits high outliers. In contrast, “No experience” plots show lower medians and smaller spreads across all age groups, especially younger participants.

In the comparison plot, the general shift upward in medians for experienced participants emphasizes that across age groups, those with VR experience reported more severe symptoms.

These observations conflict with prior research suggesting older age groups experience more severe cyber-sickness (Oh & Son, 2022). A possible reason is unequal sample sizes across age groups. Namely, there are 29 participants in the 30-37 group but only 7 in the 16-21 group. This limits reliability of comparisons. Additionally, there is more variability in smaller sample sizes, making trends harder to detect.
...
The box plots above indicate that females with experience report greater symptoms, agreeing with online research “*indicat\[ing\] excruciating symptoms of motion sickness in female*s” (Chattha et al., 2020).
