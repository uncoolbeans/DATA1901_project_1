...
These observations conflict with prior research suggesting older age groups experience more severe cybersickness (Oh & Son, 2022). A possible reason is unequal sample sizes across age groups. For example, there are 29 participants in the 30-37 group but only 7 in the 16-21 group. This limits reliability of comparisons. Additionally, there is more variability in smaller sample sizes, making trends harder to detect.
...
We maintained a shared value of respect as we respected the privacy of others and the promises of confidentiality given to them as the data we used was anonymous. We obeyed ethical principles by pursuing objectivity as we presented all findings openly, completely, and in a transparent manner regardless of the outcomes.
