...
We specifically looked at participants that did not undergo any social modelling conditions: 69 participants, each with 51 variables recorded. Our project focused the following variables:
...
Those with and without VR experience reported varied severity of symptoms. Interestingly, the VR experienced group saw a greater median `ssq_full`, at 7.0 compared to -0.5 for those without experience, indicating that those with experience reported more severe symptoms afterwards than those who had no experience. VR experienced participants also showed a greater IQR than those without, at 16.25 and 8.5 respectively, pointing to experienced users experiencing less consistent symptom severity than those who did not. This is also backed by the 'yes' group having a larger range, as well as an outlier at 53.0, whereas 'no' has a smaller range and no outliers.
...
Breaking down into individual symptoms for each group, it is seen that for almost all symptoms, those with VR experience reported a higher change between symptoms before and after.
